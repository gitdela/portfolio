...
export async function POST(request: NextRequest): Promise<Response> {
  // Rotate by setting the same newly generated value in both systems, then trigger a fresh
  // Git deployment. Sensitive Vercel values are masked when exported and cannot be reused.
